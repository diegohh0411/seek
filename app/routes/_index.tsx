  ...
  return (
    <div className="p-12 md:p-24 flex flex-col gap-12 md:gap-24">
      <div className="flex flex-col md:flex-row gap-12">
        <img className="w-full md:max-h-80 md:w-auto rounded-full hover:rotate-2 hover:scale-105 duration-500" src={profile} />
        <div className="flex flex-col gap-6">
          ...
          <p className="text-xl md:text-2xl font-monospace text-justify">Tengo 19 años, fundé el proyecto de evangelización digital <a href="https://farodefe.org" target="_blank" className="underline hover:decoration-dotted decoration-orange-400 decoration-4">Faro de Fe</a> y quiero ir a <a href="https://seek.focus.org" target="_blank" className="font-bold underline decoration-yellow-400 decoration-4 hover:decoration-dotted">SEEK 24</a>: la mayor conferencia de universitarios católicos en Estados Unidos.</p>
